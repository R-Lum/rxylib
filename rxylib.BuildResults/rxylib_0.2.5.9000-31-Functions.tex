...
1 & convert\_xy2TKA & Convert xy-data to TKA & Convert data to the Toolkit file format (TKA) as exported by, e.g., by the software Canberra Genie 2000. & 0.1.0
 &  &  & Sebastian Kreutzer, IRAMAT-CRP2A, Université Bordeaux Montaigne (France)$<$br /$>$ & Kreutzer, S., 2020. convert\_xy2TKA(): Convert xy-data to TKA. Function version 0.1.0. In: Kreutzer, S., Friedrich, J., 2020. rxylib: Import XY-Data into R . R package version 0.2.5.9000-31. https://github.com/R-Lum/rxylib
 \\ 
