...
1 & convert\_xy2TKA & Convert xy-data to TKA & Convert data to the Toolkit file format (TKA) as exported by, e.g., by the software Canberra Genie 2000. & 0.1.1
 &  &  & Sebastian Kreutzer, Institute of Geography, Universität Heidelberg, Germany$<$br /$>$ & Kreutzer, S., 2023. convert\_xy2TKA(): Convert xy-data to TKA. Function version 0.1.1. In: Kreutzer, S., Friedrich, J., 2023. rxylib: Import XY-Data into R . R package version 0.2.10.9000-8. https://github.com/R-Lum/rxylib
 \\ 
